...
<!-- Vendored from https://github.com/tigerbeetle/tigerbeetle/blob/main/docs/TIGER_STYLE.md
     Epigraph quotes cut; everything else verbatim. Re-derive by re-fetching, do not edit from memory. -->
